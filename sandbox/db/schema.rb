...
ActiveRecord::Schema.define(version: 2021_10_13_223946) do
  ...
  create_table "spree_cms_pages", charset: "utf8mb4", force: :cascade do |t|
  ...
  create_table "spree_cms_sections", charset: "utf8mb4", force: :cascade do |t|
    t.string "name", null: false
    t.text "content"
    t.text "settings"
    t.string "fit"
  ...
  create_table "spree_menu_items", charset: "utf8mb4", force: :cascade do |t|
    t.string "name", null: false
    t.string "subtitle"
    t.string "destination"
  ...
  create_table "spree_menus", charset: "utf8mb4", force: :cascade do |t|
    t.string "name"
    t.string "location"
    t.string "locale"
    t.bigint "store_id"
  ...
  create_table "spree_products_stores", charset: "utf8mb4", force: :cascade do |t|
    t.bigint "product_id"
    t.bigint "store_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "spree_promotions_stores", charset: "utf8mb4", force: :cascade do |t|
    t.bigint "promotion_id"
    t.bigint "store_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
